        ...
        {favoritos.length > 0 ? (
          favoritos.map((atleta) => (
            <div key={atleta.id} className="card-atleta">
              <img src={atleta.photo || 'https://jacksonwink.com/wp-content/uploads/2023/09/642f3a306a28fe28935d27cb_jackson-wink-mma-fighter-profile-image-placeholder-male-01-p-20001-scaled-scaled.webp'} 
                   alt={atleta.name} 
              ...
              <div className="info-atleta">
                ...
                <p>{`${atleta.wins || 0}V - ${atleta.losses || 0}D - ${atleta.draws || 0}E`}</p>
